...
// ── Pública: inicio (landing) ────────────────────────────────────
Route::get('/', [WebController::class, 'home'])->name('web.home');

// ── Pública: tienda ──────────────────────────────────────────────
Route::get('/tienda', [WebController::class, 'index'])->name('tienda');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::patch('productos/{producto}/toggleColeccion', [ProductoController::class, 'toggleColeccion'])->name('productos.toggleColeccion');
...
Route::middleware(['auth'])->group(function () {
    Route::get('/admin/moneda', [App\Http\Controllers\ConfiguracionController::class, 'index'])->name('configuracion.moneda');
    Route::put('/admin/moneda', [App\Http\Controllers\ConfiguracionController::class, 'update'])->name('configuracion.moneda.update');
});