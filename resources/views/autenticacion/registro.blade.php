...
@section('titulo', 'ZT|SHOES — Registro')
...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .reg-logo span { color: var(--rose-dark); }
...
<div class="reg-card">
  ...
  <div class="reg-header">
    <a href="/" class="reg-logo">ZT<span>|</span>SHOES</a>
    <p class="reg-eyebrow">nueva cuenta</p>
    <h1 class="reg-title">Crea tu perfil</h1>
  </div>
